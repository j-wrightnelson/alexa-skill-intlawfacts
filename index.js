...
var data = [
    ...
    "The European Union is a political and economic union, currently comprising 28 Member States. The EU has many attributes of Statehood. For example, the EU has an  international legal personality, maintains its own diplomatic missions around the world, and represents itself at the United Nations, the World Trade Organization, and in other international organizations. However, the EU is not a State, nor is it a federation. Rather, the EU describes itself as a political project, that reflects the will of the Member States to create an ever closer union among the peoples of Europe.”
];
